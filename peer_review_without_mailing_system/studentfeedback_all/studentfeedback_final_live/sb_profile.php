	...
	<body class="container">
        ...
        <div id="profile">
            <div class="col text-center">
                <b id="welcome">Welcome : <i><?php echo $_SESSION['login_name' ]?></i></b> <br>
                ...
                <b id="pname"> you worked on the Project: <i><?php echo $_SESSION['pname' ]?></i></b> <br>
                <button class="btn btn-default font-weight-bold " id="logout"><a href="sb_logout.php">Log Out</a></button>
            </div>
        </div>
        <!-done->
					...
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
						<div class="card-box">
							...
							<div class="row" "container" align="center">
								Please assess yourself and your team members on the following behaviors that have been reported as critical for the successful completion of projects. Read each statement caref ully, and enter the number that indicates the extent to which the person has demonstrated this behavior. Use the following scale:
								<br><br> 5 = perfection 4 = almost always 3 = frequently 2 = sometimes 1 = seldom 0 = almost never
								<br><br>
							</div>
							
							<form action="sb_profile.php" method="post">
							 <?php
                                ...
                                $snum_giving_feedback = "{$_SESSION['snum_giving_feedback']}";
                                echo "<input type = \"hidden\" name= \"snum_giving_feedback\" value=\"$snum_giving_feedback\" >";
                                $subject_code = "{$_SESSION['subject_code']}";
                                echo "<input type = \"hidden\" name= \"subject_code\" value=\"$subject_code\" >";
                                $available_year= "{$_SESSION['available_year']}";
                                echo "<input type = \"hidden\" name= \"available_year\" value=\"$available_year\" >";
                                $study_period = "{$_SESSION['study_period']}";
                                echo "<input type = \"hidden\" name= \"study_period\" value=\"$study_period\" >";
												...
												<tr>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0){
                                                        ...
                                                        while($row = mysqli_fetch_array($result)){
                                                            ...
                                                            echo "<input type=\"hidden\" name=\"lastname".$i."\" value=\" $lastname\">";
                                                            $i= $i+1;
                                                        }
                                                    }
                                                ?>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
                    <button type="submit" class="btn btn-default font-weight-bold " formmethod="POST" value="insert" name ="submit"  id ="submit">
                        Submit
		...
		<footer class="page-footer font-small blue">
			<!-- Copyright -->
			<div class="footer-copyright text-center py-3">© 2020 Copyright: ICT Team 07 </div>
			<!-- Copyright -->
		</footer>
		<!-- Footer -->
